...
//        System.out.println("Money after subtraction: " + pLNmoney + "\n");
    ...
    @Test
    public void throwsExceptionOnNotMatchingCurrency() {
        Money pln = new Money(BigDecimal.ZERO, Currency.PLN);
        Money euro = new Money(BigDecimal.ZERO, Currency.EURO);

        assertThrows(NotMatchingCurrencyException.class, () -> pln.checkCurrency(euro));
    }
